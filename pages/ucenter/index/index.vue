<template>  
    <view class="container">  
		...
		<view class="user-section">
			...
			<view class="user-info-box"  @click="navTo('/pages/ucenter/index')">
		...
		>
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-dizhi" iconColor="#5fcda2" title="地址管理" @eventClick="navTo('/pages/ucenter/address/address')"></list-cell>
				<list-cell icon="icon-pinglun-copy" iconColor="#ee883b" title="晒单" tips="晒单抢红包"></list-cell>
				<list-cell icon="icon-shoucang_xuanzhongzhuangtai" iconColor="#54b4ef" title="我的收藏"></list-cell>
				<list-cell icon="icon-shezhi1" iconColor="#e07472" title="设置" border="" @eventClick="navTo('/pages/ucenter/setting/index')"></list-cell>
			</view>
		</view>
...
<script>
    ...
    export default {
		...
		onNavigationBarButtonTap(e) {
			const index = e.index;
			if (index === 0) {
				this.navTo('/pages/ucenter/setting/index');
			}else if(index === 1){
				// #ifdef APP-PLUS
