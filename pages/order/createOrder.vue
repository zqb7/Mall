	...
	<view>
		...
		<view class="goods-section">
			<view class="g-header b-b">
				<image class="logo" src="https://img.alicdn.com/tfs/TB1_uT8a5ERMeJjSspiXXbZLFXa-143-59.png"></image>
				<text class="name">我的店铺</text>
			</view>
			<!-- 商品列表 -->
			<view class="g-item">
				<image :src="product.goods_pic"></image>
				<view class="right">
					<text class="title clamp">{{product.goods_name}}</text>
					<text class="spec">{{product.goods_specification_value}}</text>
					<view class="price-box">
						<text class="price">￥{{product.retail_price}}</text>
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥{{product.retail_price}}</text>
			</view>
			<view class="yt-list-cell b-b">
